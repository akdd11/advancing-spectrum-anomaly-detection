...
scene_attributes_path = os.path.join(
    module_path, "blender-python", "conf", "scene_attributes.yaml"
)
...
for obst_name in scene_attributes["obstacles"]:
    ...
    obstacle_counter, obstacle_object = create_obstacle(
        obstacle_counter,
        AnchorPoint(x, y, z),
        EdgeLengths(l, b, w),
        materials,
...
# add some light
light_counter = 0
light_counter = add_light(
    light_counter, (0.33 * room_size.x, 0.33 * room_size.y, 14), 3000
)
light_counter = add_light(
    light_counter, (0.33 * room_size.x, 0.67 * room_size.y, 14), 3000
)
light_counter = add_light(
    light_counter, (0.67 * room_size.x, 0.33 * room_size.y, 14), 3000
)
light_counter = add_light(
    light_counter, (0.67 * room_size.x, 0.67 * room_size.y, 14), 3000
)
light_counter = add_light(
    light_counter, (0.5 * room_size.x, -0.25 * room_size.y, 10), 400
)
